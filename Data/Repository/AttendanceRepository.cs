...
{
    public class AttendanceRepository : CollegeRepository<Attendance>, IAttendanceRepository
    {
        public readonly LibraryDbContext _libraryDbContext;
        public IMapper _mapper;
        public APIResponse _apiResponse;

        public AttendanceRepository(LibraryDbContext libraryDbContext, IMapper mapper) : base(libraryDbContext, mapper)
        {
